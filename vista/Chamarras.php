...
<section class="w-100">
    <div class="row w-75 mx-auto" id="servicios-fila-1">       
        <div class="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-start my-5 icono-wrap">
            <img class="imgCata" src="vista/IMGPG/C1.jpg" alt="desarrollo" >
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-start  my-5 icono-wrap">
            <img class="imgCata" src="vista/IMGPG/C2.jpg" alt="concepto" >
    ...
    <div class="row w-75 mx-auto" id="servicios-fila-1">       
        <div class="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-start my-5 icono-wrap">
            <img class="imgCata" src="vista/IMGPG/C3.jpg" alt="desarrollo"  >

            <div>
                <h3 class="fs-5 mt-4 px-4 pb-1"><?php echo $datos["nombre_producto"][2] ?>
                </h3>
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-start  my-5 icono-wrap">
            <img class="imgCata" src="vista/IMGPG/C4.jpg" alt="concepto" >
    ...
    <div class="row w-75 mx-auto" id="servicios-fila-1">       
        <div class="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-start my-5 icono-wrap">
            <img class="imgCata" src="vista/IMGPG/C5.jpg" alt="desarrollo"  >
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-start  my-5 icono-wrap">
            <img class="imgCata" src="vista/IMGPG/C6.jpg" alt="concepto" >
    ...
    <div class="row w-75 mx-auto mb-5" id="servicios-fila-2">       
        <div class="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-start  my-5 icono-wrap">
            <img class="imgCata" src="vista/IMGPG/C7.jpg" alt="comunicaciones" >
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-start my-5 icono-wrap">
            <img class="imgCata" src="vista/IMGPG/C8.jpg" alt="seo"  >
