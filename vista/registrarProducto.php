...
<body>
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-8">
                <form action="?m=registrarProduct" class="p-5 m-2 border rounded shadow" method="POST" style="background-color:white;">
                  <div class="mb-3">
                    <legend class="form-label">Registrar Producto</legend>
                  </div>
                  <div class="mb-3">
