...
<html lang="es">
  ...
  <body>
    ...
    <br>
    <center><h1>SUDADERAS</h1></center>
    <!-- TIPOS DE SERVICIOS-->
    <!--========================================================== -->
    <section class="w-100">
    <div class="row w-75 mx-auto" id="servicios-fila-1">       
        <div class="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-start my-5 icono-wrap">
            <img class="imgCata" src="vista/IMGPG/S1.jpg" alt="desarrollo" >
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-start  my-5 icono-wrap">
            <img class="imgCata" src="vista/IMGPG/S2.jpg" alt="concepto" >
    ...
    <div class="row w-75 mx-auto" id="servicios-fila-1">       
        <div class="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-start my-5 icono-wrap">
            <img class="imgCata" src="vista/IMGPG/S3.jpg" alt="desarrollo"  >
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-start  my-5 icono-wrap">
            <img class="imgCata" src="vista/IMGPG/S4.jpg" alt="concepto" >
    ...
    <div class="row w-75 mx-auto" id="servicios-fila-1">       
        <div class="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-start my-5 icono-wrap">
            <img class="imgCata" src="vista/IMGPG/S5.jpg" alt="desarrollo"  >
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-start  my-5 icono-wrap">
            <img class="imgCata" src="vista/IMGPG/S6.jpg" alt="concepto" >
    ...
    <div class="row w-75 mx-auto mb-5" id="servicios-fila-2">       
        <div class="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-start  my-5 icono-wrap">
            <img class="imgCata" src="vista/IMGPG/S7.jpg" alt="comunicaciones" >
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-start my-5 icono-wrap">
            <img class="imgCata" src="vista/IMGPG/S8.jpg" alt="seo"  >
